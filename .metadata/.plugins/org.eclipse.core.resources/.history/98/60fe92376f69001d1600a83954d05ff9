...
<meta charset="UTF-8">
	<title>header</title>
	<link rel="stylesheet" href="/project01/main/css/error.css"/> 
</head>    
	<header>
	...
	<fmt:bundle basename="resource.member">
		<div id="header" class="cf">
			...
			<nav class="nav1 cf">
				<div class="sub1Wrap">
					<h1 class="logo fl"><a href="/project01/index.jsp" tabindex="8"><img src="/project01/index/images/logo.png" alt="로고"/></a></h1>
					<ul class="sub1 cf">
